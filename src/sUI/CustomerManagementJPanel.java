...
public class CustomerManagementJPanel extends javax.swing.JPanel {
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        if(ua.accountExists(fieldusername1.getText(), fieldPassword1.getText(), "customer")) {
            ...
            this.business.getCd().createCustomer(user.getAccountId(), fieldname1.getText());
            populate();
        }
    ...
    public void populate() {
        ...
        for(Customer c: this.business.getCd().getCd()) {
            UserAccount u = this.business.getUad().findById(c.getId());
